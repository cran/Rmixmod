...
ClusteringOutputHandling::ClusteringOutputHandling(XEM::ClusteringModelOutput *cMOutput, Rcpp::S4 &xem,
                                                   const XEM::DataType dataType, Rcpp::CharacterVector const &Rcriterion)
