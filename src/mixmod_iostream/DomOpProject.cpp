...
template <class T> void DomOpProject::readXmlFillIn(T *cInput)
{
...
static void setModelOutput(LearnOutput *lOutput, vector<LearnModelOutput *> vlmo) { lOutput->setLearnModelOutput(vlmo); }
static void setModelOutput(PredictOutput *lOutput, vector<PredictModelOutput *> vlmo) { lOutput->setPredictModelOutput(vlmo); }

template <typename T, typename U> void DomOpProject::readXmlFillOut(T *cOutput, Input *inp)
{
