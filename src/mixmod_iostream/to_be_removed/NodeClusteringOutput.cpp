...
ClusteringModelOutput *NodeClusteringOutput::readClustering()
{
	...
	if (elementError) {
		...
		return new ClusteringModelOutput(modelType, nbCluster, vCriterionOutput, likelihood, *readParameter(parameterFilename),
...
void NodeClusteringOutput::writeOutput(ClusteringModelOutput *output, const std::vector<CriterionName> &criterionName,
