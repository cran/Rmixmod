...
NodeClusteringInput::NodeClusteringInput(ClusteringInput *input, string &s) : NodeInput(input, s)
{
...
void NodeClusteringInput::writeInitNode(xmlpp::Element *strategyElement, ClusteringInput *cInput, string &sFilename)
{
