...
NodeInput::NodeInput() : xmlpp::Document() { _rootInput = create_root_node("Input"); }

NodeInput::~NodeInput() {}

NodeInput::NodeInput(string &s) : xmlpp::Document() { set_internal_subset(s, "", ""); }

NodeInput::NodeInput(xmlpp::Element *rootInput) { _rootInput = create_root_node_by_import(rootInput); }
