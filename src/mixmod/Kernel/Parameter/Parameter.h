...
public:
	...
	virtual GaussianParameter *getGaussianParameter() { return (GaussianParameter *)this; }

	virtual BinaryParameter *getBinaryParameter() { return (BinaryParameter *)this; }
	/// Comparison operator
	...
	virtual void initForInitUSER_PARTITION(int64_t &nbInitializedCluster, bool *tabNotInitializedCluster,
	                                       Partition *initPartition) = 0;
...
inline int64_t Parameter::getNbCluster() const { return _nbCluster; }

inline int64_t Parameter::getPbDimension() const { return _pbDimension; }

inline double *Parameter::getTabProportion() const { return _tabProportion; }

inline bool Parameter::getFreeProportion() const { return _freeProportion; }

inline Model *Parameter::getModel() const { return _model; }

inline void Parameter::setModel(Model *iModel) { _model = iModel; }

inline void Parameter::setModelType(ModelType *iModeltype) { _modelType = iModeltype; }

inline ModelType *Parameter::getModelType() const { return _modelType; }

inline const std::string &Parameter::getFilename() const { return _filename; }

inline void Parameter::setFilename(const std::string &filename) { _filename = filename; }

inline FormatNumeric::FormatNumericFile Parameter::getFormat() const { return _format; }

inline void Parameter::setFormat(const FormatNumeric::FormatNumericFile format) { _format = format; }
