...
public:
	...
	BinaryEkjhParameter(int64_t iNbCluster, int64_t iPbDimension, ModelType *iModelType, int64_t *tabNbModality,
	                    std::string &iFileName);

	/// Constructor
	BinaryEkjhParameter(int64_t iNbCluster, int64_t iPbDimension, ModelType *iModelType, int64_t *tabNbModality,
	                    double *proportions, double **centers, double ***scatters);
...
inline double ***BinaryEkjhParameter::getScatter() const { return _scatter; }
