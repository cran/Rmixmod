...
inline double **GaussianData::getYStore() { return _yStore; }

inline double GaussianData::getInv2PiPow() const { return _Inv2PiPow; }

inline double GaussianData::getHalfPbDimensionLog2Pi() const { return _halfPbDimensionLog2Pi; }

inline double GaussianData::getPbDimensionLog2Pi() const { return _pbDimensionLog2Pi; }

inline double *GaussianData::getTmpTabOfSizePbDimension() const { return __tmpTabOfSizePbDimension; }
