...
public:
	 ...
	 * */
	virtual GaussianData *getGaussianData() { return (GaussianData *)this; }

	/**Return pointer to Binary data type. This function
	 * should be called only when it is redefined in the derived class.
	 * */
	virtual BinaryData *getBinaryData() { return (BinaryData *)this; }
	/** @brief Selector
...
inline const Sample **Data::getData() const { return const_cast<const Sample **>(_matrix); }

inline const std::string &Data::getFileNameWeight() const { return _fileNameWeight; }

inline const std::string &Data::getFileName() const { return _fileNameData; }

inline const Sample *Data::getDataI(int64_t index) const { return _matrix[index]; }

inline const double *Data::getWeight() const { return _weight; }

inline const double &Data::getWeightI(int64_t index) const { return _weight[index]; }

/// get dimension
inline int64_t Data::getPbDimension() const { return _pbDimension; }

/// get Number of samples
inline int64_t Data::getNbSample() const { return _nbSample; }

/// hasDefaultWeight
inline bool Data::hasDefaultWeight() const { return _defaultWeight; }
