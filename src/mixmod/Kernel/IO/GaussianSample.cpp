...
// Constructor
//------------
GaussianSample::GaussianSample() : Sample() { _value = NULL; }
...
// Constructor
//------------
GaussianSample::GaussianSample(GaussianSample *iSample) : Sample(iSample) { _value = copyTab(iSample->_value, _pbDimension); }
...
// set tab value
//--------------
void GaussianSample::setDataTabValue(double *tabValue) { recopyTab(tabValue, _value, _pbDimension); }

//----------
// set value
//----------
void GaussianSample::setDataValue(int64_t idxDim, double value) { _value[idxDim] = value; }
