...
WeightColumnDescription::WeightColumnDescription(int64_t index) : ColumnDescription(index) { _index = index; }

WeightColumnDescription::~WeightColumnDescription() {}

std::string WeightColumnDescription::editType() { return "Weight"; }
