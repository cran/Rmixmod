...
public:
	...
	Description(int64_t nbSample, int64_t nbColumn, std::vector<ColumnDescription *> columnDescription,
...
inline std::string Description::getInfoName() const { return _infoName; }

inline int64_t Description::getNbSample() const { return _nbSample; }

inline int64_t Description::getNbColumn() const { return _nbColumn; }

inline std::string Description::getFileName() const { return _fileName; }
...
inline const std::vector<ColumnDescription *> Description::getAllColumnDescription() const { return _columnDescription; }

inline FormatNumeric::FormatNumericFile Description::getFormat() const { return _format; }

inline void Description::setInfoName(std::string &iInfoName) { _infoName = iInfoName; }
