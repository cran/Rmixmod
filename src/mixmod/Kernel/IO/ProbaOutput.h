...
inline int64_t *ProbaOutput::getTabLabel() const { return _tabLabel; }

inline int64_t *ProbaOutput::getTabCVLabel() const { return _tabCVLabel; }

inline int64_t **ProbaOutput::getTabPartition() const { return _tabPartition; }

inline double **ProbaOutput::getTabPostProba() const { return _tabPostProba; }

inline int64_t ProbaOutput::getNbSample() const { return _nbSample; }

inline int64_t ProbaOutput::getNbCluster() const { return _nbCluster; }
