...
inline double *SymmetricMatrix::getStore() { return _store; }

inline MATH::SymmetricMatrix *SymmetricMatrix::getValue() { return _value; }

inline int64_t SymmetricMatrix::getStoreDim() { return _s_storeDim; }
...
inline void SymmetricMatrix::setSphericalStore(double /*store*/) { THROW(OtherException, wrongMatrixType); }

inline void SymmetricMatrix::setGeneralStore(double * /*store*/) { THROW(OtherException, wrongMatrixType); }

inline void SymmetricMatrix::setDiagonalStore(double * /*store*/) { THROW(OtherException, wrongMatrixType); }
