...
inline double *GeneralMatrix::getStore() { return _store; }

inline MATH::Matrix *GeneralMatrix::getValue() { return _value; }

inline int64_t GeneralMatrix::getStoreDim() { return _s_storeDim; }

inline void GeneralMatrix::setSymmetricStore(double * /*store*/) { THROW(OtherException, wrongMatrixType); }

inline void GeneralMatrix::setSphericalStore(double /*store*/) { THROW(OtherException, wrongMatrixType); }
...
inline void GeneralMatrix::setDiagonalStore(double * /*store*/) { THROW(OtherException, wrongMatrixType); }
