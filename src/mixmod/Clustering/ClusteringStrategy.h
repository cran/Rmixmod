...
public:
	...
	/// setStrategyInit
	void setStrategyInit(StrategyInitName initName, Data *&data, int64_t nbNbCluster, int64_t *tabNbCluster,
	                     ModelType *modelType);
...
inline const ClusteringStrategyInit *ClusteringStrategy::getStrategyInit() const { return _strategyInit; }

inline const Algo *ClusteringStrategy::getAlgo(int64_t index) const { return _tabAlgo[index]; }

inline std::vector<Algo *> const &ClusteringStrategy::getTabAlgo() const { return _tabAlgo; }

inline std::vector<Algo *> &ClusteringStrategy::getTabAlgo() { return _tabAlgo; }

inline int64_t ClusteringStrategy::getNbAlgo() const { return _nbAlgo; }

inline int64_t ClusteringStrategy::getNbTry() const { return _nbTry; }
